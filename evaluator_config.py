...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "llamacpp_auto_start_server": True,
    "llamacpp_server_executable": r"C:\Tools\llama.cpp\llama-server.exe",
    "llamacpp_startup_timeout_seconds": 300,
    "llamacpp_api_base_url": "http://127.0.0.1:8081",
    "llamacpp_server_context_size": 32768,
    "llamacpp_server_gpu_layers": "auto",
    "llamacpp_server_threads": 8,
    "llamacpp_server_threads_batch": 8,
    "llamacpp_server_batch_size": 1024,
    "llamacpp_server_ubatch_size": 512,
    "llamacpp_server_flash_attn": "auto",
    "llamacpp_server_cache_type_k": "q8_0",
    "llamacpp_server_cache_type_v": "q8_0",
    "llamacpp_server_parallel": 1,
    "llamacpp_server_mmap": True,
    "llamacpp_server_jinja": True,
    ...
    "llamacpp_stop_server_after_grading": False,
    "llamacpp_stop_server_on_app_close": False,
    "llamacpp_models": {
        "semantic_judge": [],
        "factual_judge": [],
        "concept_judge": [],
    ...
    "openrouter_models": {
        ...
        "factual_judge": ["z-ai/glm-5.2:free"],
        "concept_judge": ["poolside/laguna-s-2.1:free"],
        "strict_judge": ["google/gemma-4-31b-it:free"],
        "misconception_judge": ["nvidia/nemotron-3-super-120b-a12b:free"],
        "language_filter": ["google/gemma-4-26b-a4b-it:free"],
    },
