...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "openrouter_worker_count": 4,
    "ollama_worker_count": 1,
    "openrouter_api_base_url": "https://openrouter.ai/api/v1",
    "openrouter_api_key": "env:OPENROUTER_API_KEY",
    "openrouter_models": {
        "semantic_judge": ["nvidia/nemotron-3-nano-30b-a3b:free"],
        "factual_judge": ["nvidia/nemotron-3-nano-30b-a3b:free"],
        "concept_judge": ["poolside/laguna-m.1:free"],
        "strict_judge": ["nvidia/nemotron-3-nano-30b-a3b:free"],
        "misconception_judge": ["nvidia/nemotron-3-nano-30b-a3b:free"],
        "language_filter": ["nvidia/nemotron-3-nano-30b-a3b:free"],
    },
